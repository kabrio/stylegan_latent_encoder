...
class PerceptualModel:
	...
	def set_reference_images(self, _image):
		loaded_image = load_image(_image, self.img_size)
		...
		existing_features_shape = [1] + features_space
		empty_features_shape = [self.batch_size - 1] + features_space
